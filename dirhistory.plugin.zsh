...
for keymap in emacs vicmd viins; do
  ...
  bindkey -M $keymap "^B" dirhistory_zle_dirhistory_back    # GNU screen
  ...
  bindkey -M $keymap "^O" dirhistory_zle_dirhistory_future    # GNU screen
...
for keymap in emacs vicmd viins; do
  # dirhistory_up
  bindkey -M $keymap "^H" dirhistory_zle_dirhistory_up    # xterm in normal mode
